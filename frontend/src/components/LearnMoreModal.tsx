          ...
          <div className="p-8 pt-6">
            <DialogHeader className="mb-6">
              <div className="flex justify-center mb-4">
                ...
                >
                  <BookOpen size={32} style={{ color: 'oklch(0.75 0.20 295)' }} />
                </div>
              </div>
            ...
            <ScrollArea className="max-h-72 pr-2">
              <div className="space-y-4">
                ...
                >
                  Zoritlegends is more than just a server — it's a thriving community built for
                  players who want to grow, compete, and connect. Whether you're a beginner looking
                  to learn the ropes or a seasoned player ready to dominate, Zoritlegends gives you
                ...
                <div>
                  <p
                    ...
                    style={{ fontSize: '0.5rem', color: 'oklch(0.80 0.20 295)', letterSpacing: '0.08em' }}
                  >
                ...
                >
                  At Zoritlegends, every player has the chance to become a legend. We focus on
                  improvement, teamwork, and creating unforgettable moments.
                </p>
                ...
                >
                  Join today, sharpen your abilities, and start your journey toward greatness.
                </p>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: '0 4px 0 oklch(0.28 0.14 295), inset 0 2px 0 oklch(0.72 0.22 295)',
                fontSize: '0.6rem',
                letterSpacing: '0.1em',
              }}
              onMouseEnter={(e) => {
