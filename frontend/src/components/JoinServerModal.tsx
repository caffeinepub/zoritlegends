...
import { Copy, Check, Server, X } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export default function JoinServerModal({ open, onClose }: JoinServerModalProps) {
      ...
      <DialogContent className="max-w-md border-0 p-0 overflow-hidden bg-transparent shadow-none">
        <div
          ...
          style={{
            ...
            boxShadow: '0 0 0 2px oklch(0.25 0.10 295), 0 0 40px oklch(0.62 0.22 295 / 0.4), 8px 8px 0 oklch(0.08 0.03 295)',
          }}
        >
          <div
            className="h-2 w-full"
            style={{
              background: 'repeating-linear-gradient(90deg, oklch(0.62 0.22 295) 0px, oklch(0.62 0.22 295) 8px, oklch(0.45 0.18 295) 8px, oklch(0.45 0.18 295) 16px)',
            }}
          />
          ...
          <div className="p-8 pt-6">
            <DialogHeader className="mb-6">
              ...
              <DialogTitle className="text-center font-pixel text-sm leading-relaxed" style={{ color: 'oklch(0.97 0.01 295)' }}>
                Join ZoritLegends
              </DialogTitle>
              <DialogDescription className="text-center mt-2" style={{ color: 'oklch(0.65 0.08 295)', fontFamily: 'Inter, sans-serif', fontSize: '0.875rem' }}>
            ...
            <div className="mb-5 space-y-2">
              {[
                'Open Minecraft Java or Bedrock Edition',
                'Go to Multiplayer → Add Server',
                'Paste the IP below and connect!',
              ].map((step, i) => (
                <div key={i} className="flex items-start gap-3">
                  ...
                  <span style={{ color: 'oklch(0.75 0.08 295)', fontSize: '0.8rem', fontFamily: 'Inter, sans-serif' }}>
                    {step}
                  </span>
                </div>
              ))}
            ...
            <div className="mb-5">
              <p className="text-xs mb-2 font-pixel" style={{ color: 'oklch(0.55 0.15 295)', fontSize: '0.5rem' }}>
                SERVER IP
              </p>
              <div
            ...
            {copied && (
              <p
                ...
                style={{ color: 'oklch(0.65 0.18 145)', fontFamily: 'Inter, sans-serif' }}
              >
          ...
          <div
            className="h-2 w-full"
            style={{
              background: 'repeating-linear-gradient(90deg, oklch(0.45 0.18 295) 0px, oklch(0.45 0.18 295) 8px, oklch(0.30 0.12 295) 8px, oklch(0.30 0.12 295) 16px)',
            }}
          />
        </div>
      </DialogContent>
