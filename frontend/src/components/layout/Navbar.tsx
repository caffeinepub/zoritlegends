...
import { Menu, X, Sword, LogOut, ChevronDown } from 'lucide-react';
            ...
            <div className="hidden md:flex items-center gap-1">
              {navLinks.map((link) => (
                <button
                  ...
                  onMouseEnter={(e) => {
                    (e.currentTarget as HTMLElement).style.color = 'oklch(0.97 0.01 295)';
                  }}
                  onMouseLeave={(e) => {
            ...
            <div className="hidden md:flex items-center gap-2">
              {username ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    onMouseEnter={(e) => {
                      (e.currentTarget as HTMLElement).style.borderColor = 'oklch(0.55 0.20 25)';
                      (e.currentTarget as HTMLElement).style.color = 'oklch(0.75 0.18 25)';
                    }}
                    onMouseLeave={(e) => {
                      (e.currentTarget as HTMLElement).style.borderColor = 'oklch(0.35 0.14 295)';
                      (e.currentTarget as HTMLElement).style.color = 'oklch(0.65 0.10 295)';
                    }}
                  >
                    <LogOut size={11} />
                    LOGOUT
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow: '0 3px 0 oklch(0.12 0.06 295), inset 0 1px 0 oklch(0.35 0.14 295)',
                    fontSize: '0.5rem',
                  ...
                  onMouseLeave={(e) => {
                    (e.currentTarget as HTMLElement).style.background = 'oklch(0.22 0.10 295)';
                  }}
                >
                  ⚔ LOGIN
                </button>
              ...
              <button
                ...
                style={{
                  ...
                  color: 'oklch(0.99 0 0)',
                  boxShadow: '0 3px 0 oklch(0.30 0.15 295), inset 0 1px 0 oklch(0.70 0.22 295)',
                  fontSize: '0.55rem',
                  letterSpacing: '0.08em',
                }}
                onMouseEnter={(e) => {
              ...
              {username ? (
                <div className="pt-2 space-y-2">
                  ...
                  >
                    ...
                    <span
                      className="font-pixel"
                      style={{ fontSize: '0.5rem', color: 'oklch(0.85 0.15 295)' }}
                    >
                      {username}
                    </span>
                  </div>
