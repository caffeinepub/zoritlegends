import { Package, Gem, Crown } from 'lucide-react';
...
const packages = [
  {
    ...
    name: 'Starter Pack',
    price: 'FREE',
    features: ['Basic starter kit', 'Access to all game modes', 'Community chat', '1 home location'],
    highlight: false,
  ...
  },
  {
    ...
    name: 'Legend Rank',
    price: '$9.99',
    features: ['Exclusive Legend prefix', 'Custom particle effects', '5 home locations', 'Priority queue access', 'Monthly reward crate'],
    highlight: true,
  ...
  },
  {
    ...
    name: 'Mythic Rank',
    price: '$19.99',
    features: ['Mythic crown prefix', 'All Legend perks', 'Unlimited homes', 'Custom join message', 'Exclusive Mythic kit', 'VIP Discord access'],
    highlight: false,
          ...
          {packages.map((pkg) => {
            ...
            return (
              <div
                ...
                style={{
                  background: pkg.highlight ? 'oklch(0.18 0.10 295)' : 'oklch(0.14 0.06 295)',
                ...
                <div className="p-6 flex flex-col flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h3
                      ...
                      style={{ fontSize: '0.65rem', color: 'oklch(0.97 0.01 295)' }}
                    >
                      {pkg.name}
                    </h3>
                  </div>
                  ...
                  <button
                    ...
                    style={{
                      background: pkg.highlight ? 'oklch(0.55 0.25 295)' : 'oklch(0.20 0.09 295)',
                      color: 'oklch(0.99 0 0)',
                      boxShadow: pkg.highlight
