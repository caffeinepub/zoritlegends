import { Shield, Sword, Trophy, Zap, Users } from 'lucide-react';
...
const features = [
  {
    ...
    fallbackIcon: Shield,
    title: 'Survival',
    description: 'Explore vast biomes, gather resources, and build your empire from scratch. The world is yours to conquer.',
  ...
  },
  {
    ...
    fallbackIcon: Sword,
    title: 'PvP Arena',
    description: 'Test your skills against the best players. Ranked matches, tournaments, and epic battles await.',
  ...
  },
  {
    ...
    fallbackIcon: Trophy,
    title: 'Events',
    description: 'Join weekly events, seasonal challenges, and special tournaments with exclusive rewards and prizes.',
...
const extraFeatures = [
  { icon: Zap, title: 'Low Latency', desc: 'Optimized servers for the best performance' },
          ...
          {features.map((feature) => {
            ...
            return (
              <div
                ...
                onMouseLeave={(e) => {
                  (e.currentTarget as HTMLElement).style.borderColor = 'oklch(0.28 0.12 295)';
          ...
          {extraFeatures.map((ef) => {
            ...
            return (
              <div key={ef.title} className="flex items-center gap-4 p-3">
                ...
                <div>
                  <p className="font-pixel" style={{ fontSize: '0.55rem', color: 'oklch(0.90 0.08 295)', marginBottom: '2px' }}>
                    {ef.title}
                  </p>
                  <p style={{ fontFamily: '"VT323", monospace', fontSize: '0.95rem', color: 'oklch(0.55 0.08 295)' }}>
                    {ef.desc}
                  </p>
                </div>
              </div>
