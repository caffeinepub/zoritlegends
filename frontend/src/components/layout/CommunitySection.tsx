      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            >
              Be part of a thriving community of players who share your passion for adventure
            </p>
          </div>
              ...
              >
                <div className="flex gap-1 mb-3">
                  {[...Array(t.stars)].map((_, i) => (
                    <span key={i} style={{ color: 'oklch(0.75 0.20 80)', fontSize: '0.9rem' }}>★</span>
                  ))}
                </div>
                <p
                  className="mb-4"
          ...
          >
            <div className="absolute top-0 left-0 w-4 h-4" style={{ background: 'oklch(0.55 0.22 295)' }} />
            <div className="absolute top-0 right-0 w-4 h-4" style={{ background: 'oklch(0.55 0.22 295)' }} />
            <div className="absolute bottom-0 left-0 w-4 h-4" style={{ background: 'oklch(0.55 0.22 295)' }} />
            <div className="absolute bottom-0 right-0 w-4 h-4" style={{ background: 'oklch(0.55 0.22 295)' }} />
